...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        GL20.glAttachShader((int)program, (int)this.createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/acrimony/shader/passthrough.vsh"), 35633));
    ...
    private int createShader(InputStream inputStream, int shaderType) throws IOException {
        ...
        if (compiled == 0) {
            System.err.println(GL20.glGetShaderInfoLog((int)shader, (int)35716));
