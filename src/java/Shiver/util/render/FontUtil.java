...
implements IMinecraft {
    ...
    public static void initFonts() {
        ...
        productSans = Shiver.instance.getFontManager().getProductSans();
        sfpro = Shiver.instance.getFontManager().getSfpro();
        sfprobold = Shiver.instance.getFontManager().getSfprobold();
        geistbold = Shiver.instance.getFontManager().getGeistbold();
    }
