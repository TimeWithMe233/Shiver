...
import Shiver.util.player.ArmorType;
...
extends Module {
    ...
    private void hotbarExchange(int hotbarNumber, int slotId) {
        InventoryManager.mc.playerController.windowClick(InventoryManager.mc.thePlayer.inventoryContainer.windowId, slotId, hotbarNumber, 2, (EntityPlayer)InventoryManager.mc.thePlayer);
        this.delay = 0;
    }

    private void shiftClick(int slotId) {
        InventoryManager.mc.playerController.windowClick(InventoryManager.mc.thePlayer.inventoryContainer.windowId, slotId, 1, 1, (EntityPlayer)InventoryManager.mc.thePlayer);
        this.delay = 0;
    }

    private void drop(int slotId) {
        InventoryManager.mc.playerController.windowClick(InventoryManager.mc.thePlayer.inventoryContainer.windowId, slotId, 1, 4, (EntityPlayer)InventoryManager.mc.thePlayer);
        this.delay = 0;
    }
    ...
    private float getAttackDamage(ItemStack stack) {
        ...
        float enchantsDamage = (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.sharpness.effectId, (ItemStack)stack) * 1.25f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.fireAspect.effectId, (ItemStack)stack) * 0.3f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.knockback.effectId, (ItemStack)stack) * 0.15f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.unbreaking.effectId, (ItemStack)stack) * 0.1f;
    ...
    private float getToolUsefulness(ItemStack stack) {
        ...
        float enchantsUsefulness = (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.fortune.effectId, (ItemStack)stack) * 1.25f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.unbreaking.effectId, (ItemStack)stack) * 0.3f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.infinity.effectId, (ItemStack)stack) * 0.5f + 0.0f;
    ...
    private float getArmorProtection(ItemStack stack) {
        ...
        float enchantsProtection = (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.protection.effectId, (ItemStack)stack) * 1.25f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.blastProtection.effectId, (ItemStack)stack) * 0.15f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.fireProtection.effectId, (ItemStack)stack) * 0.15f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.projectileProtection.effectId, (ItemStack)stack) * 0.15f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.thorns.effectId, (ItemStack)stack) * 0.1f + (float)EnchantmentHelper.getEnchantmentLevel((int)Enchantment.unbreaking.effectId, (ItemStack)stack) * 0.1f;
