...
public class Cape
extends Module {
    private final ModeSetting cmode = new ModeSetting("Cape Mode", "Shiver", "Shiver", "Rise", "Dortware", "Hanabi", "Diablo", "Astolfo", "Expensive", "Hantai", "Hantai1", "Hantai2", "Hantai3", "Hantai4", "Hantai5", "Hantai6", "Hantai7");
