package Shiver.module.impl.visual.motionblur;
...
extends ShaderGroup {
    ...
    public void parseGroup(TextureManager p_152765_1_, ResourceLocation p_152765_2_) throws IOException, JsonSyntaxException {
        JsonObject jsonobject = Shiver.instance.getModuleManager().getModule(CustomGui.class).getJsonObject();
        ...
        if (JsonUtils.isJsonArray((JsonObject)jsonobject, (String)"passes")) {
