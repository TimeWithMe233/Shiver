...
extends HUDModule {
    private final ModeSetting mode = new ModeSetting("Mode", "Shiver", "Shiver", "Outline", "Blur", "Zeroday", "Novoline", "Lime Recode");
    ...
    public void onClientStarted() {
        ...
        this.icons = Shiver.instance.getFontManager().getIcon1regular();
    }
    ...
    protected void renderModule(boolean inChat) {
        ...
        if (inChat && this.isEnabled()) {
            ...
            this.renderTargetHUD((EntityPlayer)TargetHUD.mc.thePlayer, true);
            this.target = null;
    ...
    private void renderTargetHUD(EntityPlayer entity, boolean canRender) {
        ...
        AcrimonyFont sfsverymall = Shiver.instance.getFontManager().getSfproverysmall();
        AcrimonyFont sfbold = Shiver.instance.getFontManager().getSfprobold();
        AcrimonyFont geistBold = Shiver.instance.getFontManager().getGeistbold();
                ...
                switch (this.mode.getMode()) {
                    case "Shiver": {
                        ...
                        if (this.blurbg.isEnabled()) {
                            Shiver.instance.blurHandler.blur((double)x, (double)y, (double)this.width, (double)(this.height - 7), 0.0f);
                        ...
                        for (double i = (double)(x + 40); i < endAnimX; i += 1.0) {
                            Gui.drawRect((double)i, (double)(y + 35), (double)(i + 1.0), (double)(y + 38), (int)this.theme.getColor((int)(200.0 + i * 20.0)));
                        }
                    ...
                    case "Novoline": {
                        if (this.novoblur.isEnabled()) {
                            Shiver.instance.blurHandler.bloom(x - 1, y - 1, this.width + 2, this.height - 8, 8, new Color(0, 0, 0, 150));
                        }
                        ...
                        if (this.novoblur.isEnabled()) {
                            Shiver.instance.blurHandler.bloom(x + 40, y + 22, (int)(14.0 + 82.0 * healthMult), 12, 8, ClientTheme.color1.getRGB());
                        }
                        ...
                        TargetHUD.mc.fontRendererObj.drawStringWithShadow(entity.getGameProfile().getName(), (float)(x + 40), (float)(y + 8), -1);
                        TargetHUD.mc.fontRendererObj.drawString(health + "%", (float)(x + 76), (float)(y + 24), -1);
                        break;
                    }
                    case "Blur": {
                        ...
                        DrawUtil.drawHead(((AbstractClientPlayer)entity).getLocationSkin(), x + 8, y + 8, 36, 36);
                        StencilUtil.uninitStencilBuffer();
                        Shiver.instance.blurHandler.bloom(x + 52, y + 36, (int)(79.0 * healthMult), 8, 2, this.theme.getColor(1));
                    ...
                    case "Zeroday": {
                        Shiver.instance.blurHandler.bloom(x, y, this.width + 20, this.height + 10, 10, new Color(0, 0, 0, 100));
                        ...
                        sfsmall.drawStringWithShadow("" + Math.round((double)TargetHUD.mc.thePlayer.getDistanceToEntity((Entity)entity) - 0.5), (float)x + 67.2f, y + 26, new Color(255, 255, 255).getRGB());
                        ...
                        DrawUtil.drawRoundedRect(x, y, x, y, 0.0, new Color(255, 255, 255, 255).getRGB());
                        Gui.drawRect((double)x, (double)(y + this.height + 8), (double)(x + 160), (double)(y + this.height + 10), (int)new Color(1, 1, 1, 200).getRGB());
                        ...
                        DrawUtil.drawRoundedRect(x, y, x, y, 0.0, new Color(255, 255, 255, 255).getRGB());
                        GuiInventory.drawEntityOnScreen((int)(x + 22), (int)(y + 54), (int)26, (float)(-entity.rotationYaw), (float)entity.rotationPitch, (EntityLivingBase)entity);
                    ...
                    case "Lime Recode": {
                        Shiver.instance.blurHandler.bloom(x - 1, y, this.width - 2, this.height - 20, 5, new Color(0, 0, 0, 200));
                        ...
                        DrawUtil.drawHead(((AbstractClientPlayer)entity).getLocationSkin(), x + 4, y + 4, 32, 32);
                        Gui.drawRect((double)(x + 40), (double)(y + 27), (double)((double)(x + 54 + 82) + Math.max(130.0, 42.0 + FontUtil.getStringWidth(this.font.getMode(), entity.getName()) + 3.0) - (double)this.width + 15.0), (double)(y + 36), (int)new Color(30, 29, 29, 202).getRGB());
                        GL11.glScissor((int)(x + 40), (int)(y + 27), (int)((int)((double)((int)((double)(x + 54) + 82.0 * healthMult)) + Math.max(130.0, 42.0 + FontUtil.getStringWidth(this.font.getMode(), entity.getName()) + 3.0) - (double)this.width + 15.0)), (int)(y + 99));
