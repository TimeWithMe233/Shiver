...
import Shiver.util.animation.glowesp.DecelerateAnimation;
import Shiver.util.animation.glowesp.DecelerateAnimationParent;
import Shiver.util.animation.glowesp.GlowESPShaderUtil;
import Shiver.util.misc.MathUtils;
import Shiver.util.render.RenderUtil;
import Shiver.util.render.StencilUtil;
import Shiver.util.shader.ShaderUtil;
...
extends Module {
    ...
    public final void onRender3D(Render3DEvent e) {
        ...
        this.entities.forEach(entity -> mc.getRenderManager().renderEntityStaticNoShadow(entity, e.getPartialTicks(), false));
