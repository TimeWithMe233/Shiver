...
implements IMinecraft {
    ...
    public float getYaw() {
        return this.freelooking && !Shiver.instance.isDestructed() ? this.cameraYaw : CameraHandler.mc.thePlayer.rotationYaw;
    }

    public float getPitch() {
        return this.freelooking && !Shiver.instance.isDestructed() ? this.cameraPitch : CameraHandler.mc.thePlayer.rotationPitch;
    }

    public float getPrevYaw() {
        return this.freelooking && !Shiver.instance.isDestructed() ? this.cameraYaw : CameraHandler.mc.thePlayer.prevRotationYaw;
    }
