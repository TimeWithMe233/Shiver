...
import Shiver.oauth.CookieLogin;
import Shiver.oauth.OAuthService;
...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.font = Shiver.instance.getFontManager().getSfpro();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.font.drawCenteredString(this.status == null ? EnumChatFormatting.YELLOW + "Idle..." : this.getStatus(), this.width / 2, 29.0f, -1);
        ...
        for (Button button : this.buttons) {
            if (mouseX > startX && mouseX < endX && (double)mouseY > y && (double)mouseY < y + (double)buttonHeight) {
                switch (button.getName()) {
                    ...
                    case "Back": {
                        this.mc.displayGuiScreen(Shiver.instance.getMainMenu());
                    }
                }
