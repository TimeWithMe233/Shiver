package Shiver.ui.click.dropdown;
...
import Shiver.setting.impl.ColorSetting;
...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        AcrimonyFont frs = Shiver.instance.getFontManager().getSfprosmall();
        AcrimonyFont frr = Shiver.instance.getFontManager().getSfprobold22();
        this.icons = Shiver.instance.getFontManager().getIconregular();
        for (CategoryHolder category : this.categories) {
            ...
            Gui.drawRect((double)(x - 2), (double)y, (double)(x + 120 + 2), (double)(y + 18), (int)0);
            ...
            for (ModuleHolder holder : category.getModules()) {
                ...
                if (this.module.boxOnHover.isEnabled() && !m.isEnabled() && (float)mouseX > startX && (float)mouseX < endX && (float)mouseY > startY && (float)mouseY < endY) {
                    Gui.drawRect((double)startX, (double)startY, (double)endX, (double)endY, (int)0x30000000);
                }
                ...
                Gui.drawRect((double)(startX - 1.0f), (double)startY, (double)(endX + 1.0f), (double)(endY + 1.0f), (int)this.moduleDisabledColor.getRGB());
                if (m.isEnabled()) {
                ...
                float textHeight = FontUtil.getFontHeight(Shiver.instance.getFontManager().getSfpro().toString());
                ...
                if (holder.isSettingsShown()) {
                    ...
                    Gui.drawRect((double)(startX - 1.0f), (double)startKeybindY, (double)(endX + 1.0f), (double)endKeybindY, (int)new Color(38, 38, 38, 255).getRGB());
                    if (this.module.boxOnHover.isEnabled() && this.module.boxOnSettings.isEnabled() && (float)mouseX > startX + 1.0f && (float)mouseX < endX - 1.0f && (float)mouseY > startKeybindY && (float)mouseY < endKeybindY) {
                        Gui.drawRect((double)startX, (double)startKeybindY, (double)endX, (double)endKeybindY, (int)0x30000000);
                    }
                    frs.drawStringWithShadow(this.keyChangeModule == m ? "Waiting..." : "Keybind : " + Keyboard.getKeyName((int)m.getKey()), startX + 18.0f, startKeybindY + 6.0f, -1);
                    ...
                    for (SettingHolder settingHolder : holder.getSettings()) {
                        ...
                        Gui.drawRect((double)(startX - 1.0f), (double)startSettingY, (double)(endX + 1.0f), (double)(endSettingY + 1.0f), (int)this.moduleDisabledColor.getRGB());
                        ...
                        if (settingHolder.getSetting() instanceof ModeSetting) {
                            ...
                            Gui.drawRect((double)startX, (double)endSettingY, (double)endX, (double)endSettingY, (int)this.moduleDisabledColor.getRGB());
                            if (frs.getStringWidth(toRender) > 117) {
                                if (this.module.boxOnHover.isEnabled() && this.module.boxOnSettings.isEnabled() && (float)mouseX > startX + 1.0f && (float)mouseX < endX - 1.0f && (float)mouseY > startSettingY && (float)mouseY < endSettingY + 6.0f) {
                                    Gui.drawRect((double)startX, (double)startSettingY, (double)endX, (double)(endSettingY + 6.0f), (int)0x30000000);
                                }
                                ...
                                Gui.drawRect((double)startX, (double)startSettingY, (double)(startX + 120.0f), (double)(startSettingY + 18.0f - 2.0f), (int)0x50000000);
                                if (this.module.boxOnHover.isEnabled() && this.module.boxOnSettings.isEnabled() && hoveringSetting) {
                                    Gui.drawRect((double)startX, (double)startSettingY, (double)endX, (double)endSettingY, (int)0x30000000);
                                }
                            ...
                            if (settingHolder.getSetting() instanceof BooleanSetting) {
                                ...
                                Gui.drawRect((double)(startX + 2.0f), (double)(startSettingY + 2.0f), (double)(startX + 6.0f), (double)(startSettingY + 18.0f - 4.0f), (int)Integer.MIN_VALUE);
                                ...
                                Gui.drawRect((double)startSettingX, (double)(startSettingY + 12.0f), (double)endSettingX, (double)(startSettingY + 14.0f), (int)Integer.MIN_VALUE);
                                ...
                                if (this.cursorTimer.getTimeElapsed() % 1200L < 600L && this.customDSetting == doubleSetting) {
                                    Gui.drawRect((double)(startSettingX + (float)fr.getStringWidth(aaa) + 2.0f), (double)(startSettingY + 3.0f), (double)(startSettingX + (float)fr.getStringWidth(aaa) + 3.0f), (double)(startSettingY + 14.5f), (int)this.theme.getColor((int)(endX - 12.0f + (float)y)));
                                }
