...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            Shiver.instance.getEventManager().post(new UpdateEvent());
            super.onUpdate();
            ...
            else
            {
                ...
                Shiver.instance.getEventManager().post(new PostMotionEvent());
            }
        }
    }
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        Shiver.instance.getEventManager().post(actionEvent);
        ...
        Shiver.instance.getEventManager().post(motionEvent);
