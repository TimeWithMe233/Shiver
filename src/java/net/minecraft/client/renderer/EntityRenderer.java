...
import Shiver.module.impl.visual.motionblur.CustomShaderGroup;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            if(isPlayer) {
                Reach reachModule = Shiver.instance.getModuleManager().getModule(Reach.class);
            ...
            for (Entity entity1 : list) {
                ...
                float f1 = entity1.getCollisionBorderSize() + ((entity instanceof EntityPlayer && !entity.isInvisible()) ? exp : 0);
            ...
            if(this.pointedEntity != null) {
                //Acrimony.getInstance().addChatMessage("" + vec3.distanceTo(vec33));
            }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        CameraHandler cameraHandler = Shiver.instance.getCameraHandler();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Shiver.instance.getEventManager().post(new Render3DEvent(partialTicks));
