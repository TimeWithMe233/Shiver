...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException, NoSuchAlgorithmException {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(Shiver.instance.getMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(Shiver.instance.getMainMenu());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.8.9" + " - " + "亲爱的Election用户");
    }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Shiver.instance.getMainMenu();
        }
        ...
        if (guiScreenIn instanceof GuiMainMenu || guiScreenIn instanceof ShiverMenu)
        {
    ...
    private void runGameLoop() throws IOException
    {
        ...
        for (int j = 0; j < this.timer.elapsedTicks; ++j)
        {
            if(Minecraft.getMinecraft().thePlayer != null) {
                ...
                if(j == 0) {
                    Tickbase tickBase = Shiver.instance.getModuleManager().getModule(Tickbase.class);
    ...
    public void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            if (this.objectMouseOver == null)
            {
                ...
                if (this.playerController.isNotCreative() && !Shiver.instance.getModuleManager().getModule(DelayRemover.class).isEnabled())
                {
            ...
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case BLOCK:
                        ...
                        Killaura killauraModule = Shiver.instance.getModuleManager().getModule(Killaura.class);
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            Shiver.instance.getEventManager().post(new TickEvent());
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        Shiver.instance.getEventManager().post(new KeyPressEvent(k));
