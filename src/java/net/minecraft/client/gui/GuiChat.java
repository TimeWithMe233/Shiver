...
public class GuiChat extends GuiScreen
{
    ...
    public void onGuiClosed()
    {
        ...
        for(HUDModule m : Shiver.instance.getModuleManager().hudModules) {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        if(state == 0) {
            Shiver.instance.getModuleManager().hudModules.forEach(m -> m.setHoldingMouse(false));
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Shiver.instance.getModuleManager().hudModules.forEach(m -> {
            double startX = m.posX.getValue();
            double startY = m.posY.getValue();
