...
import Shiver.event.impl.EntityMoveEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityMovement(S14PacketEntity packetIn)
    {
        ...
        if (entity != null) {
            ...
            Shiver.instance.getEventManager().post(new EntityMoveEvent(entity));
        }
    }
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(Shiver.instance.getMainMenu()), "disconnect.lost", reason));
        }
    }
