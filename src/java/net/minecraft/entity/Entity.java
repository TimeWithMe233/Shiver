...
import Shiver.event.impl.RaytraceEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if(this == Minecraft.getMinecraft().thePlayer) {
                Safewalk safewalkModule = Shiver.instance.getModuleManager().getModule(Safewalk.class);
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if(isPlayer) {
                    Shiver.instance.getEventManager().post(new PostStepEvent((float) (this.getEntityBoundingBox().minY - this.posY)));
                }
            }
    ...
    public Vec3 getLook(float partialTicks) {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            Shiver.instance.getEventManager().post(raytraceEvent);
        }
